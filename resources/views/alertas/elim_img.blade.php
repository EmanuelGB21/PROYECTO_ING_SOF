<div class="modal fade" id="img{{$img->id_imagen}}"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <form action="{{url('imagenes_ruta/'.$img->id_imagen)}}" method="POST">
                        @csrf
                        @method('DELETE')   
                        <input type="hidden" name="ruta_imagen" value="{{$img->ruta_imagen}}">
                        <div class="mt-3">
