<nav class="navbar navbar-expand-md navbar-dark fixed-top shadow-sm panel_inicial p-2">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('pagina_principal') }}">
            <div class="row">
                <div class="col-2">
                  <h4 class="animate__animated animate__lightSpeedInLeft"><i class="fa fa-shop"></i></h4>
                </div>
                <div class="col-2">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="btn btn-dark text-light position-relative"
